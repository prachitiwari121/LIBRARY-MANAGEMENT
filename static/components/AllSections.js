            ...
            <div class="px-3 mt-3">
                <div class="clearfix">
                    <div class="float-start">
                        <h3 class="mb-0 text-dark">All Sections</h3>
                    </div>
                    <div class="float-end">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 mt-3" v-for="(section,i) in sections" :key="i">
                        <div class="circle-container">
                            <div class="circle p-3">
                                <div class="card-header text-dark d-flex justify-content-center align-items-center flex-column">
                                    <span class="h5">{{section.section_name}}</span>
                                    <span class="stars">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button class="btn btn-warning btn-sm me-1" v-if="role=='libr'" @click="editSection(section.section_id)">Edit</button>
                                        <button class="btn btn-danger btn-sm me-1" v-if="role=='libr'" @click="deleteEdit(section.section_id)">Delete</button>
                                        <button class="btn btn-success btn-sm">
                                            <router-link class="text-white" :to="'/section/'+section.section_id">View</router-link>
                                        </button>
                                    </div>
                                </div>
                            </div>
